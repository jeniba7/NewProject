...
public class Common_Method_POST extends GenerateReports {
	    ...
	    //Method to send a POST request with Authorization
	    public static Response sendPostRequest(String baseURI, JSONObject requestBody) {
